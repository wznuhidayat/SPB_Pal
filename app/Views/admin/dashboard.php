            ...
            <div class="row clearfix">
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box-3 bg-cyan hover-zoom-effect">
                        ...
                        <div class="content">
                            <div class="text">TOTAL BARANG HARI INI</div>
                            <div class="number"><?= $count_all; ?></div>
                        </div>
                    </div>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box-3 bg-blue hover-zoom-effect">
                        ...
                        <div class="content">
                            <div class="text">BARANG PERSONAL</div>
                            <div class="number"><?= $item_person; ?></div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box-3 bg-light-green hover-zoom-effect">
                        ...
                        <div class="content">
                            ...
                            <div class="number"><?= $item_material; ?></div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
