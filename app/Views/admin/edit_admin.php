                        ...
                        <form action="/administator/saveAdmin" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group form-float">
                                <div class="form-line <?= ($validation->hasError('name')) ? 'error' : '' ?>">
                                    <input type="text" class="form-control" name="name" value="<?= $admin['nama']; ?>" required aria-required="true">
                                    <label class="form-label">Name</label>
                                    <label id="minmaxlength-error" class="error" for="minmaxlength"><?= $validation->getError('name'); ?></label>
                                </div>
                            </div>
                            <div class="form-group">
                                <input type="radio" name="gender" id="male" value="L" class="with-gap" <?php echo ($admin['gender'] == "L" ? 'checked="checked"': ''); ?> >
                                <label for="male">Laki-laki</label>

                                <input type="radio" name="gender" id="female" value="P" class="with-gap" <?php echo ($admin['gender'] == "P" ? 'checked="checked"': ''); ?> >
